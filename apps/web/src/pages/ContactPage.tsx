  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-lg">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">{t('contact.sendUsMessage')}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full rounded-lg bg-blue-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-colors hover:bg-blue-700 hover:shadow-xl disabled:opacity-50"
              >
          ...
          {/* Contact Information */}
          <div className="rounded-2xl bg-white p-8 shadow-lg">
            <h2 className="mb-8 text-2xl font-bold text-gray-900">{t('contact.ourContactInfo')}</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 font-semibold text-gray-900">{t('contact.hours')}</h3>
            ...
            <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0">
                  <svg className="mt-0.5 h-5 w-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <h4 className="mb-1 font-medium text-blue-900">{t('contact.information')}</h4>
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h2 className="mb-8 text-center text-3xl font-bold text-gray-900">{t('contact.ourLocation')}</h2>

          {/* Map Container */}
          <div className="relative h-96 overflow-hidden rounded-2xl bg-gray-100 shadow-lg">
            {/* Google Maps Iframe */}
            <iframe
            ...
            {/* Overlay Info Card */}
            <div className="absolute bottom-4 left-4 z-10 max-w-xs rounded-lg bg-white p-4 shadow-lg">
              <div className="flex items-start space-x-3">
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100">
                  <span className="text-sm font-bold text-blue-600">AE</span>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">{t('contact.companyName')}</h3>
                  <p className="text-xs text-gray-600">123 Av. des Champs-Élysées</p>
                  <p className="text-xs text-gray-600">75008 Paris, France</p>
                  <div className="mt-2 flex items-center">
                    ...
                    <span className="ml-1 text-xs text-gray-400">{t('contact.reviews')}</span>
                  </div>
                  <div className="mt-1 flex items-center">
                    <div className="mr-2 h-2 w-2 rounded-full bg-green-500"></div>
                    <p className="text-xs text-green-600">{t('contact.openNow')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <a
                ...
                className="inline-flex items-center rounded-lg bg-blue-600 px-6 py-3 font-medium text-white shadow-lg transition-colors hover:bg-blue-700 hover:shadow-xl"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center rounded-lg bg-green-600 px-6 py-3 font-medium text-white shadow-lg transition-colors hover:bg-green-700 hover:shadow-xl"
              >
                <svg className="mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
